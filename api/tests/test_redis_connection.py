    ...
    try:
        ...
        try:
            ...
            if active_workers:
                ...
                logger.warning("⚠️  No active workers found. Task will timeout unless a worker is started.")
        ...
        try:
            ...
            try:
                ...
                logger.error(f"❌ Task execution failed (likely no worker running): {e}")
                logger.info("💡 To fix this, start a Celery worker with: make start_celery")
                return False
